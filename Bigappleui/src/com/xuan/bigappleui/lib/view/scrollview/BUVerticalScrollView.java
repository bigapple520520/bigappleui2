 ...
 * @author xuan
 */
public class BUVerticalScrollView extends ScrollView {
	...
	public BUVerticalScrollView(Context context) {
		super(context);
	}

	public BUVerticalScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
