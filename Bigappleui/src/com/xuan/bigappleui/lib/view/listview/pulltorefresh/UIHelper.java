...
public abstract class UIHelper extends BaseUIHelper {
	 ...
	 * @return
	 */
	public static BUFooterView getFooterView(Activity activity) {
		BUFooterView footerView = new BUFooterView(activity);
	 ...
	 * @return
	 */
	public static BUHeaderView getHeaderView(Activity activity) {
		BUHeaderView headerView = new BUHeaderView(activity);
