 ...
 * 界面:<br>
 * <activity android:name="com.xuan.bigappleui.lib.camera.BUCameraActivity"
...
public class CameraActivity extends Activity {
	...
	private void initWidgets() {
		...
		flashBtn.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View arg0) {
				boolean isOpen = PreferenceModel.instance(CameraActivity.this)
						.getBoolean(CameraConfig.CAMERA_FLASH_OPEN, false);
				PreferenceModel.instance(CameraActivity.this).putBoolean(
	...
	private void takePicture(ShutterCallback shutter, PictureCallback raw,
		...
		boolean isFlashOpen = PreferenceModel.instance(CameraActivity.this)
				.getBoolean(CameraConfig.CAMERA_FLASH_OPEN, false);
		if (isFlashOpen) {
			// 拍照时，开启闪光灯
