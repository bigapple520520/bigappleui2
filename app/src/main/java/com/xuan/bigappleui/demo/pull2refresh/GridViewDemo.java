...
import com.xuan.bigappleui.lib.pullrefresh.widget.PullToRefreshGridView;
...
public class GridViewDemo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pullToRefreshGridView.setPullDownRefreshEnabled(true);
		pullToRefreshGridView.setPullUpRefreshEnabled(true);
