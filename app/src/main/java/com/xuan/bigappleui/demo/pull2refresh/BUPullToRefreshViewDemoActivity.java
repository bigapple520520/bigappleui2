 ...
 * @author xuan
 */
public class BUPullToRefreshViewDemoActivity extends Activity {

	private BUPullToRefreshListView pullToRefreshListView;
	...
	private void initWidgets() {
		pullToRefreshListView = (BUPullToRefreshListView) findViewById(R.id.pullToRefreshListView);
		...
		pullToRefreshListView
				.setPullToRefreshListViewListener(new BUPullToRefreshListViewListener() {
					@Override
