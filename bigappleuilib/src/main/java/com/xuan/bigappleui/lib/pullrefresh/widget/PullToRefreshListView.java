package com.xuan.bigappleui.lib.pullrefresh.widget;
...
import com.xuan.bigappleui.lib.pullrefresh.core.AbstractLoadingLayout;
import com.xuan.bigappleui.lib.pullrefresh.core.FooterLoadingLayout;
...
public class PullToRefreshListView extends PullToRefreshBase<ListView>
	...
	@Override
	public void setScrollUpRefreshEnabled(boolean scrollLoadEnabled) {
		super.setScrollUpRefreshEnabled(scrollLoadEnabled);
	...
	private boolean isLastItemVisible() {
		...
		/**
		 * 这个检查条件其实应该是：lastVisiblePosition ==
		 * lastItemPosition,但是ListView内部会使用一个FooterView导致了位置错乱。
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		if (isScrollUpRefreshEnabled() && hasMoreData()) {
