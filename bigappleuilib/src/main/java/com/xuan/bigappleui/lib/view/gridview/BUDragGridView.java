 ...
 */
public class BUDragGridView extends GridView {
	...
	public BUDragGridView(Context context) {
		this(context, null);
	}

	public BUDragGridView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public BUDragGridView(Context context, AttributeSet attrs, int defStyle) {
