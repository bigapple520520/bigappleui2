 ...
 * 默认文件保存路径：data data packageName shared_prefs packageName_preferences.xml<br>
 ...
 *          2012) $
 */
public class BUPreferences {
	private SharedPreferences prefs;
	private Editor prefsEdit;
	private static BUPreferences instance;

	private BUPreferences() {
	}
	 ...
	 * @return
	 */
	public static BUPreferences instance() {
		if (null == instance) {
			instance = new BUPreferences();
			instance.prefs = PreferenceManager
					.getDefaultSharedPreferences(BigappleUI
