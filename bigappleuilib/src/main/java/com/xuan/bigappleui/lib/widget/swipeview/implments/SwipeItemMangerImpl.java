package com.xuan.bigappleui.lib.widget.swipeview.implments;
...
import com.xuan.bigappleui.lib.widget.swipeview.SimpleSwipeListener;
...
public class SwipeItemMangerImpl implements SwipeItemMangerInterface {
	...
	class OnLayoutListener implements SwipeLayout.OnLayout {
		...
		@Override
		public void buOnLayout(SwipeLayout v) {
			if (isOpen(position)) {
				v.open(false, false);
			} else {
				v.close(false, false);
