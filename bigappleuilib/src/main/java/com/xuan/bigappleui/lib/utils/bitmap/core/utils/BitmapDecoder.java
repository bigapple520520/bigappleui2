package com.xuan.bigappleui.lib.utils.bitmap.core.utils;
...
public abstract class BitmapDecoder {
	...
	public static Bitmap decodeSampledBitmapFromFile(String filename,
		...
		try {
			...
			BULogUtil.e("DecodeFile OutOfMemoryError. Cause:" + e.getMessage(),
					e);
			return null;
		}
	}
	...
	public static int calculateInSampleSize(BitmapFactory.Options options,
		...
		if (DEBUG) {
			BULogUtil.d("CalculateInSampleSize params:height[" + height
