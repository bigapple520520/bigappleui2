...
public interface BUIPhotoView {
	...
	void setOnMatrixChangeListener(
			BUPhotoViewAttacher.OnMatrixChangedListener listener);
	 ...
	 *            - Listener to be registered.
	 */
	void setOnPhotoTapListener(BUPhotoViewAttacher.OnPhotoTapListener listener);
	 ...
	 */
	BUPhotoViewAttacher.OnPhotoTapListener getOnPhotoTapListener();
	 ...
	 *            - Listener to be registered.
	 */
	void setOnViewTapListener(BUPhotoViewAttacher.OnViewTapListener listener);
	 ...
	 */
	BUPhotoViewAttacher.OnViewTapListener getOnViewTapListener();
	 ...
	 */
	BUIPhotoView getIPhotoViewImplementation();
