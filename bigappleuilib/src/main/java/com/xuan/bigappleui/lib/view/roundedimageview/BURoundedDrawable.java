package com.xuan.bigappleui.lib.view.roundedimageview;
 ...
 */
public class BURoundedDrawable extends Drawable {
	 ...
	 * @param bitmap
	 */
	public BURoundedDrawable(Bitmap bitmap) {
	 ...
	 * @return
	 */
	public BURoundedDrawable setCornerRadius(float radius) {
	 ...
	 * @return
	 */
	public BURoundedDrawable setBorderWidth(float width) {
		mBorderWidth = width;
		mBorderPaint.setStrokeWidth(mBorderWidth);
		return this;
	}
	 ...
	 * @return
	 */
	public BURoundedDrawable setBorderColor(int color) {
	 ...
	 * @return
	 */
	public BURoundedDrawable setBorderColor(ColorStateList colors) {
	 ...
	 * @return
	 */
	public BURoundedDrawable setOval(boolean oval) {
		mOval = oval;
		return this;
	}
	 ...
	 * @return
	 */
	public BURoundedDrawable setScaleType(ScaleType scaleType) {
		if (null == scaleType) {
	...
	public Bitmap toBitmap() {
		return BURoundedDrawable.drawableToBitmap(this);
	}
	 ...
	 * @return
	 */
	public static BURoundedDrawable fromBitmap(Bitmap bitmap) {
		if (null != bitmap) {
			return new BURoundedDrawable(bitmap);
		} else {
			return null;
		}
	}
	...
	public static Drawable fromDrawable(Drawable drawable) {
		if (null != drawable) {
			if (drawable instanceof BURoundedDrawable) {
