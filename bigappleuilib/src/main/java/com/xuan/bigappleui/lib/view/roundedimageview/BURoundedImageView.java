 ...
 */
public class BURoundedImageView extends ImageView {
	...
	private ColorStateList borderColor = ColorStateList
			.valueOf(BURoundedDrawable.DEFAULT_BORDER_COLOR);
	...
	public BURoundedImageView(Context context) {
		super(context);
	}

	public BURoundedImageView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public BURoundedImageView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setImageDrawable(Drawable drawable) {
		mResource = 0;
		mDrawable = BURoundedDrawable.fromDrawable(drawable);
		updateDrawableAttrs();
	...
	public void setImageBitmap(Bitmap bm) {
		mResource = 0;
		mDrawable = BURoundedDrawable.fromBitmap(bm);
		updateDrawableAttrs();
		super.setImageDrawable(mDrawable);
	}
	...
	private Drawable resolveResource() {
		...
		return BURoundedDrawable.fromDrawable(drawable);
	}
	...
	private void updateBackgroundDrawableAttrs(boolean convert) {
		if (mutateBackground) {
			if (convert) {
				mBackgroundDrawable = BURoundedDrawable
	...
	private void updateAttrs(Drawable drawable) {
		...
		if (drawable instanceof BURoundedDrawable) {
			((BURoundedDrawable) drawable).setScaleType(mScaleType)
